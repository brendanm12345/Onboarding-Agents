# Refactored Python Automation Library
...
def enter_ticker(page: Page, ticker: str) -> None:
    ...
    # Ensure not to press enter to avoid premature submission
...
def add_variables(page: Page, variables: list) -> None:
    ...
    for variable in variables:
        ...
        page.get_by_role("textbox", name="Search All").fill(variable)
        page.locator("#select_all_container_div-08689682-4bdf-3947-97d8-433f285f28a9").get_by_text(f"{variable}").click()
...
def perform_query_and_download(page: Page) -> None:
    ...
    # Handle the popup or tab here if required (e.g., wait for download to complete)
